...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Restaurant.num_reservations'
        db.add_column('opentable_restaurant', 'num_reservations', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Restaurant.num_reservations'
        db.delete_column('opentable_restaurant', 'num_reservations')
